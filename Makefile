...
# Template: app
# Command: /home/n/Qt5.7.0/5.7/gcc_64/bin/qmake -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile compiler.pro
#############################################################################
...
LINK          = g++
LFLAGS        = -Wl,-rpath,/home/n/Qt5.7.0/5.7/gcc_64/lib
